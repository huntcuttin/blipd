...
export default function LoginPage() {
  ...
  // Surface magic-link failures redirected here from /auth/callback instead
  // of leaving the user on a bare sign-in screen with no explanation.
  useEffect(() => {
    const code = searchParams.get("error");
    if (code) {
      setError(ERROR_MESSAGES[code] ?? ERROR_MESSAGES.auth_failed);
      setShowEmail(true);
    }
  }, [searchParams]);
